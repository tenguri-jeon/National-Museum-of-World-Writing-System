...
const mainVisual = () => { 
    ...
    let totalImage = lis.length, interval = 5000, timer = null , current = 0, old = 0 , liWidth = lis[0].clientWidth;
...
const sec3Banner = () => {
    ...
    function nextBanner(current, old, num) {
        ...
        $bannerli[friend].style.left = `${(liWidth + 64) * ($bannerli.length - 2)}px`;
        $bannerli[friend2].style.left = `${(liWidth + 64) * ($bannerli.length - 1)}px`;
...
const sec4Bannerl = () => {
    ...
    function nextBanner(current , old , num){
        ...
        $bannerli[friend].style.left = `${(liWidth + 23) * ($bannerli.length - 2)}px`;
    ...
    function backgroundControl(className) {
        ...
        switch (className.slice(11 , 12)) {
            case '1':
                $bg.style.background =
                    'url(../images/main_sec4_Bimg1.png) no-repeat center / cover';
                $bg.animate([{ opacity: 0.8 }, { opacity: 1 }], 500);
                $bannertxt[0].classList.add('active');
                break;
            case '2':
                $bg.style.background =
                    'url(../images/main_sec4_Bimg2.png) no-repeat center / cover';
                $bg.animate([{ opacity: 0.8 }, { opacity: 1 }], 500);
                $bannertxt[1].classList.add('active');
                break;
            case '3':
                $bg.style.background =
                    'url(../images/main_sec4_Bimg3.png) no-repeat center / cover';
                $bg.animate([{ opacity: 0.8 }, { opacity: 1 }], 500);
                $bannertxt[2].classList.add('active');
                break;
            case '4':
                $bg.style.background =
                    'url(../images/main_sec4_Bimg4.png) no-repeat center / cover';
                $bg.animate([{ opacity: 0.8 }, { opacity: 1 }], 500);
...
const ani = () => {
    ...
    let con4theadTr = document.querySelector('#container #content .con4 .inner table thead tr');
    let con3lis = document.querySelector( '#container #content .con3 .inner .con3-r-wrap .con3-banner-wrap .con3_banner');
    ...
    let con1img = document.querySelector('#container #content .con1 .container figure');
    let con1backgroundRedTxt = document.querySelector('#container #content .con1 strong');
    let con1rightBox= document.querySelector('#container #content .con1 .container .right-contents');
    let con2contents = document.querySelector('#container #content .con2 .sec2-banner ul');
    let tbody = document.querySelector('#container #content .con4 .inner table tbody');
